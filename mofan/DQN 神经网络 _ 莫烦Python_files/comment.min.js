...
function insertThirdPartyLogin(){$(".nav-notification").css({display:"none"});$("#third-party-oauth-login").empty();$("<p>",{class:"third-party-oauth-login-p",text:"其他方式登录"}).appendTo("#third-party-oauth-login");const srcs=["github.png","qq_icon.png","weibo.png","gitee.png"]
